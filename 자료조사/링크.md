...
● [웹 소캣](https://tecoble.techcourse.co.kr/post/2021-08-14-web-socket/)


<pre>
< 라즈베리 파이 -> 실시간 알람 >
1. 라즈베리파이에서 아두이노로부터 읽어들인 센서값을 웹으로 출력하는 방법 : 
...
2. flask 프로그램 사용하여 라즈베리파이 화면을 가져오는? 살짝 아닌 것 같긴 한데 비슷해서 참고용으로 챙겨옴
...
3. 라즈베리파이+노드레드+jquery+websocket+IoT보드 이용해서 웹에 실시간 전송하기
